...
if (!module.parent){
  ...
  builder(args.length ? args : false, { minify:false }, function (err, content) {
    ...
    fs.write(
        fs.openSync(__dirname + '/../dist/binarypack.js', 'w')
      , content
      , 0
      , 'utf8'
    );
    console.log('Successfully generated the development build: binarypack.js');
  });
  ...
  builder(args.length ? args : false, function (err, content) {
    ...
    fs.write(
        fs.openSync(__dirname + '/../dist/binarypack.min.js', 'w')
      , content
      , 0
      , 'utf8'
    );
    console.log('Successfully generated the production build: binarypack.min.js');
  });
}